...
const rawSocials = [
  { 
    name: "Instagram", url: "https://www.instagram.com/omnitensors?igsh=cmFyaGYwYzk5bnU=", color: "#E1306C", 
  ...
  { 
    name: "Facebook", url: "https://www.facebook.com/share/1CQLGujhx4/", color: "#1877F2", 
    svgPath: `<path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>`
  },
  { 
    name: "Twitter / X", url: "https://x.com/Omnitensors", color: "#1DA1F2", 
  ...
  { 
    name: "LinkedIn", url: "https://www.linkedin.com/company/omnitensorpvtltd/", color: "#0A66C2", 
