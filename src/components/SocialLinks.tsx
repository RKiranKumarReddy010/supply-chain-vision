export default function SocialLinks() {
  const links = [
    { href: 'https://www.linkedin.com/company/OMNITENSORSpvtltd', label: 'LinkedIn', svg: (
    ...
    { href: 'https://www.instagram.com/OMNITENSORSs/', label: 'Instagram', svg: (
    ...
    { href: 'https://x.com/OMNITENSORSs', label: 'X', svg: (
